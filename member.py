...
class DummyMember(object):
    ...
    def __init__(self, dispersy, database_id, mid):
        ...
        # The SHA1 hash is 20 bytes in size
...
class Member(DummyMember):
    ...
    def __init__(self, dispersy, key, database_id):
        ...
        super(Member, self).__init__(dispersy, database_id, mid=key.hash())
    ...
    def signature_length(self):
        ...
        """
        return self._key.signature_length
    ...
    def verify(self, data, signature, offset=0, length=0):
        ...
        return self._key.verify(signature, data[offset:offset + length])
    ...
    def sign(self, data, offset=0, length=0):
        ...
        if self._key.has_private_key:
            return self._key.sign(data[offset:offset + length])
        else:
